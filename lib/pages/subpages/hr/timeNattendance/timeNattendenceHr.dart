...
class _TimeNattendenceHrState extends State<TimeNattendenceHr> {
 ...
 /*  List<double> latitudelists=[12.906285,12.913958,12.879077];//site showroom factory's latitudes  //testing
  List<double> longitudelists=[74.828268,74.847951,74.853015];//site showroom factory's longitudes*/

  List<String> premisisidlists=["PC2","ST1","TRD"];//site showroom factory's premisisids;
 ...
 /* double _destinationLatitude=12.906285;  //testing
  double _destinationLongitude=74.828268; */
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    MyApi.postPunchedTime(premisisid: premisisidlists[tag], checktype: false);
                  },
                  style: ButtonStyle(
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    MyApi.postPunchedTime(premisisid: premisisidlists[tag], checktype: true);
                  },
                  style: ButtonStyle(
                      minimumSize: MaterialStateProperty.all(const Size(0, 40)),
                      padding: MaterialStateProperty.all(const EdgeInsets.symmetric(horizontal: 12)),
