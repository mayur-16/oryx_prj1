...
class MyPdf {
  ...
  Future<void> savePdf({required String savePdfAs,required Document sourcefile}) async {
    Directory directory =
    ...
    file.writeAsBytesSync(await sourcefile.save()); // Save the created pdf in the path
